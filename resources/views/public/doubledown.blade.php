...
$uniqueVoucher = 'TTI_$100_' . substr(str_shuffle($characters), 0, 7);
...
<div class="container">
    <div class="row">
        <h1>Register for a Voucher | Double Down</h1>

        <div class="col-md-8 col-md-offset-2">

          <p>
            Register to get $100 off of a Rambo Turnout when you redeem your voucher at a participating retailer from October 14th through 17th
          </p>
