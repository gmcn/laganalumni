...
<form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/add-events') }}">
{!! csrf_field() !!}
  ...
  <div class="form-group">
    <input type="text" class="form-control" name="startDate" placeholder="Event Date" value="">
