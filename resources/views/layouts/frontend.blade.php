    ...
    <div class="">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav main-nav">
          ...
          <li>
            <a href="http://laganheritage.websiteni.com/" target="blank">Heritage</a>
          </li>
            </ul>
          </li>
        </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-8 newsletter">
            ...
            <div class="col-md-10 col-md-offset-2 contactdetails">
              Tel: 028 9040 1810<br />
              Web: <a href="http://www.lagancollege.com">www.lagancollege.com</a><br />
              Email: <a href="mailto:info@lagancollege.com">info@lagancollege.com</a><br />
              Address: 44 Manse Road, Belfast BT8 6SA
            </div>
